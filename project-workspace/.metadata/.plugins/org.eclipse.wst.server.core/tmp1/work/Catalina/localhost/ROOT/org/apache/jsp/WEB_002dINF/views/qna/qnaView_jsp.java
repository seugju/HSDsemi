 ...
 * Generated at: 2020-12-02 08:40:26 UTC
...
public final class qnaView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("qna.model.vo.QnaComment");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    ArrayList<QnaComment> list = (ArrayList<QnaComment>)request.getAttribute("list");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\t\t.qnaView>table>tbody>tr>th>a{\r\n");
      ...
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("\t\t.qnaView>table>tbody>tr>td{\r\n");
      out.write("\t\tborder-top: 1px solid #dfd3d3;\r\n");
      out.write("        }\r\n");
      out.write("        .qnaView>table>tbody>tr:nth-child(3)>td{\r\n");
      ...
      out.write("            width: 100%;\r\n");
      out.write("            background-color: #f3e1e1;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      ...
      out.write("            border: none;\r\n");
      out.write("            background-color: #b8b0b0;\r\n");
      out.write("        }\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t.commentList>ul>li:nth-child(2){\r\n");
...
if(m!=null && m.getMemberId().equals(q.getqWriter())) {
      out.write("\r\n");
      out.write("                        <a href=\"/qnaUpdateFrm?qnaNo=");
      out.print(q.getQnaNo() );
      out.write("\" class=\"btn-post\">수정</a>\r\n");
      out.write("                        <a href=\"/qnaDelete?qnaNo=");
      out.print(q.getQnaNo() );
      out.write("\" class=\"btn-post\">삭제</a>\r\n");
      out.write("                          \r\n");
      out.write("                        ");
} 
      out.write("\r\n");
      out.write("                        <a href=\"/qnaList?reqPage=1\" class=\"btn-post\" style=\"border:none;\">목록</a>\r\n");
      out.write("                    </th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <th class=\"firstth\" colspan=\"2\" style=\"width: 1000px; height: 50px; font-weight:500; font-size: 30px; border-top: 3px solid #f1d1d1;\">");
      out.print(q.getqTitle() );
      out.write("</th>\r\n");
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td style=\"height: 30px; font-weight:bold;\">");
      ...
      out.write("            \r\n");
      out.write("                <tr>\r\n");
      out.write("                    <td colspan=\"2\" style=\"height:200px; vertical-align:top;\">");
      out.print(q.getQContentBr() );
      out.write("</td>\r\n");
      out.write("                </tr>\r\n");
      out.write("\r\n");
      out.write("            </table>\r\n");
...
for(QnaComment qc : list) {
      ...
      out.write("            \t<ul>\r\n");
      out.write("            \t\t<li>\r\n");
      out.write("            \t\t\t<p style=\"width : 20%; font-weight:bold;\">");
      out.print(qc.getQnaCommentWriter() );
      out.write("</p>\r\n");
      out.write("            \t\t\t<p style=\"width : 80%; text-align: right;\">");
      out.print(qc.getQnaCommentDate() );
      out.write("</p>\r\n");
      out.write("            \t\t</li>\r\n");
      out.write("            \t\t<li>\r\n");
      out.write("            \t\t\t<div class=\"flex\">\r\n");
      out.write("            \t\t<p style=\"width : 80%;\">");
      out.print(qc.getQnaCommentContentBr() );
      out.write("</p>\r\n");
      out.write("            \t\t<textarea name = \"qnaCommentContent\" class=\"changeComment\" style=\"width: 80%; resize: none;display:none;\">");
      out.print(qc.getQnaCommentContent() );
      out.write("</textarea>\r\n");
      out.write("            \t\t");
if(m != null) {
      out.write("\r\n");
      out.write("            \t\t<p class=\"linkBox\" style=\"width:20%; text-align:right;\">\r\n");
      out.write("            \t\t");
if(m.getMemberId().equals(qc.getQnaCommentWriter())) {
      out.write("\r\n");
      out.write("            \t\t<a href=\"javascript:void(0)\" onclick=\"modifyComment(this,'");
      out.print(qc.getQnaCommentNo());
      out.write('\'');
      out.write(',');
      out.write('\'');
      out.print(q.getQnaNo());
...
if(m!=null && m.getMemberLevel()==0) {
      ...
      out.write("                <form action=\"/insertQnaComment\" method=\"post\">\r\n");
      out.write("                    <ul>\r\n");
      out.write("                        <li>\r\n");
      out.write("                            <input type=\"hidden\" name=\"qnaCommentWriter\" value=");
      out.print(m.getMemberId() );
      out.write(">\r\n");
      out.write("                            <input type=\"hidden\" name=\"qnaRef\" value=");
      out.print(q.getQnaNo() );
      out.write(">\r\n");
      out.write("                            <textarea class=\"qnaCommenttext\"style=\"height: 100px;resize: none;\"name=\"qnaCommentContent\"></textarea>                           \r\n");
      out.write("                        </li>\r\n");
      ...
      out.write("\r\n");
      out.write("    <script>\r\n");
      out.write("\tfunction modifyComment(obj, commentNo, qnaNo){\r\n");
      out.write("\t\t$(obj).parent().parent().css(\"border\",\"1px solid #b8b0b0\");\r\n");
      out.write("\t\t$(obj).parent().prev().css(\"outline\",\"none\");\r\n");
      out.write("\t\t$(obj).parent().prev().css(\"height\",\"100px\");\r\n");
      out.write("    \t$(obj).parent().prev().show();\t//textarea를 보여주는 코드\r\n");
      out.write("\t\t$(obj).parent().prev().prev().hide();\t//p태그를 숨기는 코드\r\n");
      out.write("\t\t//수정버튼 -> 수정완료\r\n");
      out.write("\t\t$(obj).html('수정완료');\r\n");
      out.write("\t\t$(obj).attr('onclick', 'modifyComplete(this,\"'+commentNo+'\",\"'+qnaNo+'\")');\r\n");
      out.write("\t\t//삭제버튼 -> 수정취소\r\n");
      out.write("\t\t$(obj).next().html('취소');\r\n");
      out.write("\t\t$(obj).next().attr('onclick', 'modifyCancel(this,\"'+commentNo+'\",\"'+qnaNo+'\")')\r\n");
      out.write("\t\t$(obj).next().next().hide();\r\n");
      out.write("    }\r\n");
      out.write("\tfunction modifyCancel(obj, commentNo, qnaNo){\r\n");
      out.write("\t\t$(obj).parent().parent().css(\"border\",\"none\");\r\n");
      out.write("\t\t$(obj).parent().prev().hide();\t//textarea를 숨기는 코드\r\n");
      out.write("\t\t$(obj).parent().prev().prev().show();\t//p태그를 보여주는 코드\r\n");
      out.write("\t\t//수정완료 -> 수정\r\n");
      out.write("\t\t$(obj).prev().html('수정');\r\n");
      out.write("\t\t$(obj).prev().attr('onclick','modifyComment(this,\"'+commentNo+'\",\"'+qnaNo+'\")')\r\n");
      out.write("\t\t//취소 - >삭제\r\n");
      out.write("\t\t$(obj).html('삭제');\r\n");
      out.write("\t\t$(obj).attr('onclick','modifyComment(this,\"'+commentNo+'\",\"'+qnaNo+'\")')\r\n");
      out.write("\t\t$(obj).next().show();\r\n");
      out.write("    }\r\n");
      out.write("    function modifyComplete(obj, commentNo, qnaNo){\r\n");
      out.write("    \tvar form = $(\"<form action='/qnaCommentUpdate' method='post'></form>\");\r\n");
      out.write("    \tform.append($(\"<input type='text' name='qnaCommentNo' value='\"+commentNo+\"'>\"));\r\n");
      out.write("    \tform.append($(\"<input type='text' name='qnaNo' value='\"+qnaNo+\"'>\"));\r\n");
      out.write("    \tform.append($(obj).parent().prev());\r\n");
      out.write("    \t$(\"body\").append(form);\r\n");
      out.write("    \tform.submit();\r\n");
      out.write("    }\r\n");
      out.write("    function deleteComment(obj, commentNo, qnaNo){\r\n");
      out.write("    \tif(confirm(\"댓글을 삭제하시겠습니까?\")){\r\n");
      out.write("    \t\tlocation.href=\"/qnaCommentDelete?qnaCommentNo=\"+commentNo+\"&qnaNo=\"+qnaNo;\t\r\n");
      out.write("    \t}\r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("    \r\n");
