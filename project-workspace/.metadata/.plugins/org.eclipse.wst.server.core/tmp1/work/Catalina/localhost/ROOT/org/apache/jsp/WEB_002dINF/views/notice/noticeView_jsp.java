 ...
 * Generated at: 2020-12-02 08:35:24 UTC
...
public final class noticeView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	Notice n = (Notice) request.getAttribute("n");
      ...
      out.write("                background-color: rgb(252, 157, 154);\r\n");
      out.write("            }\r\n");
      out.write("            .content{\r\n");
      out.write("            \t\r\n");
      out.write("            }\r\n");
...
if(m.getMemberLevel() == 0) {
      ...
      out.write("        <button type=\"button\" class=\"content-btn\"><a href=\"/noticeList?reqPage=1\">목록</a></button>\r\n");
      out.write("        </div>\r\n");
      out.write("        \r\n");
      out.write("            <table class=\"content-table\">\r\n");
      out.write("                <tr style=\"border-bottom: 2px solid #FBB1B5;\"  height=\"30px\">\r\n");
      out.write("                \t <th width=\"20%\">  제목</th>\r\n");
      out.write("\t\t\t\t<td width=\"80%\" style=\"font-size: 16px; font-weight: bold;\">");
      ...
      out.write("                </tr>\r\n");
      out.write("                <tr>\r\n");
      out.write("                \t<td colspan=\"2\" style=\"padding-left: 10px;padding-right: 10px; height:400px; vertical-align:top;\">\r\n");
      out.write("                \t");
...
if (m != null && m.getMemberId().equals(n.getNoticeWriter())) {
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<a href=\"/noticeUpdateFrm?noticeNo=");
      out.print(n.getNoticeNo() );
      out.write("\" class=\"modify-btn\">수정</a>\r\n");
      out.write("\t\t\t\t\t<a href=\"/noticeDelete?noticeNo=");
      out.print(n.getNoticeNo() );
      out.write("\" class=\"modify-btn\">삭제</a>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\t\t\t\t");
} 
      out.write("\r\n");
      ...
      out.write("\t<script>\r\n");
      out.write("\r\n");
      out.write("\t\t$(\".recShow\").click(function() {\r\n");
      out.write("\t\t\t$(this).hide();\r\n");
      out.write("\t\t\tvar idx = $(\".recShow\").index(this);\r\n");
      out.write("\t\t\t$(\".recCancel\").eq(idx).parents(\"div\").css(\"display\",\"block\");\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$(\".recCancel\").click(function() {\r\n");
      out.write("\t\t\tvar idx=$(\".recCancel\").index(this);\r\n");
      out.write("\t\t\t$(this).parents(\".re\").css(\"display\",\"none\");\r\n");
      out.write("\t\t\t$(\".recShow\").eq(idx).show();\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction modifyComment(obj, commentNo, noticeNo){\r\n");
      out.write("\t\t\t$(obj).parent().prev().show();\t\t\t//textarea를 보여주는 코드\r\n");
      out.write("\t\t\t$(obj).parent().prev().prev().hide();\t//p태그를 숨기는 코드\r\n");
      out.write("\t\t\t//수정버튼 -> 수정완료\r\n");
      out.write("\t\t\t$(obj).html('수정완료');\r\n");
      out.write("\t\t\t$(obj).attr('onclick','modifyComplete(this,\"'+commentNo+'\",\"'+noticeNo+'\")');\r\n");
      out.write("\t\t\t//삭제버튼 -> 수정취소\r\n");
      ...
      out.write("\t\t}\r\n");
      out.write("\t\tfunction modifyCancel(obj,commentNo,noticeNo){\r\n");
      out.write("\t\t\t$(obj).parent().prev().hide();\t\t\t//textarea를 숨기는 코드\r\n");
      out.write("\t\t\t$(obj).parent().prev().prev().show();\t//p태그를 보여주느는 코드\r\n");
      out.write("\t\t\t//수정완려 -> 수정\r\n");
      out.write("\t\t\t$(obj).prev().html('수정');\r\n");
      out.write("\t\t\t$(obj).prev().attr('onclick','modifyComment(this,\"'+commentNo+'\",\"'+noticeNo+'\")');\r\n");
      out.write("\t\t\t//최소 -> 삭제\r\n");
      out.write("\t\t\t$(obj).html('삭제');\r\n");
      out.write("\t\t\t$(obj).attr('onclick','deleteComment(this,\"'+commentNo+'\",\"'+noticeNo+'\")');\r\n");
      out.write("\t\t\t$(obj).next().show();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction modifyComplete(obj,commentNo, noticeNo){\r\n");
      ...
      out.write("\t\t\tform.append($(\"<input type='text' name='noticeNo' value='\"+noticeNo+\"'>\"));\r\n");
